...
export const Header = ({classes}: HeaderProps) => {
    ...
    return (
        <header
            className={`absolute top-0 left-0 w-full z-50 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 ${classes?.root} ${isNotHomePage && 'bg-blue-teal-gradient'}`}>
                    ...
                    <ul className="flex text-white">
                        <li>
                            <div className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 fill-current text-white"
                                     viewBox="0 0 24 24">
                                    <path
                                        d="M12,2C7.589,2,4,5.589,4,9.995C3.971,16.44,11.696,21.784,12,22c0,0,8.029-5.56,8-12C20,5.589,16.411,2,12,2z M12,14 c-2.21,0-4-1.79-4-4s1.79-4,4-4s4,1.79,4,4S14.21,14,12,14z"/>
                                </svg>

                                <span className="ml-2">1985 Kerry Way, Whittier, CA, USA testing</span>
                            </div>
                        </li>
                        <li className="ml-6">
                            <div className="flex items-center">
