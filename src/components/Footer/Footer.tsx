    ...
    <footer className="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
        <div className="flex flex-col md:flex-row">
            <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
                ...
                <p className="text-gray-400">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
                    nonumy.</p>
                ...
                <form className="flex items-center mt-6">
                    <div className="w-full">
                        ...
                        <div className="relative">
                            ...
                            <button type="submit"
                                    className="bg-teal-500 hover:bg-teal-400 text-white px-4 py-2 text-sm font-bold rounded absolute top-0 right-0 my-2 mr-2">Subscribe
                            </button>
                        </div>
                    </div>
                </form>
            ...
            <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                ...
                <ul className="mt-4">
                    <li className="mt-2"><a href="#" title="" className="opacity-75 hover:opacity-100">General
                        Dentistry</a>
                    </li>
                    <li className="mt-2"><a href="#" title="" className="opacity-75 hover:opacity-100">Cosmetic
                        Dentistry</a></li>
                    <li className="mt-2"><a href="#" title="" className="opacity-75 hover:opacity-100">Oral Health</a>
                    </li>
                </ul>
            </div>
            ...
            <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                ...
                <p className="text-sm text-gray-400 mt-12">© 2018 ProDentists. <br className="hidden lg:block"/>All
                    Rights
                    Reserved.
                </p>
            </div>
